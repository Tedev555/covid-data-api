...
public class ApiController {
    ...
    public ResponseEntity<?> getCovidCases() {
        ...
        provinceList.add(new Province("ນຫລ ວຽງຈັນ", 905, 12));
        provinceList.add(new Province("ບໍລິຄຳໄຊ", 3, 0));
        provinceList.add(new Province("ຄຳມ່ວນ", 6, 0));
        provinceList.add(new Province("ສະຫວັນນະເຂດ", 106, 2));
        ...
        provinceList.add(new Province("ຈຳປາສັກ", 325, 3));
        ...
        data.put("totalInfected", 1929);
        data.put("newCases", 17);
        data.put("provinces", provinceList);
        data.put("active", 327);
        data.put("death", 3);
        data.put("recovered", 1599);
        data.put("test", 246368);
